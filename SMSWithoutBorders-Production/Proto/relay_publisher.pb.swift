...
struct Publisher_V1_GetPNBACodeRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Publisher_V1_GetPNBACodeResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Publisher_V1_ExchangePNBACodeAndStoreRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Publisher_V1_ExchangePNBACodeAndStoreResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Publisher_V1_RevokeAndDeletePNBATokenRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Publisher_V1_RevokeAndDeletePNBATokenResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Publisher_V1_GetPNBACodeRequest: @unchecked Sendable {}
extension Publisher_V1_GetPNBACodeResponse: @unchecked Sendable {}
extension Publisher_V1_ExchangePNBACodeAndStoreRequest: @unchecked Sendable {}
extension Publisher_V1_ExchangePNBACodeAndStoreResponse: @unchecked Sendable {}
extension Publisher_V1_RevokeAndDeletePNBATokenRequest: @unchecked Sendable {}
extension Publisher_V1_RevokeAndDeletePNBATokenResponse: @unchecked Sendable {}
